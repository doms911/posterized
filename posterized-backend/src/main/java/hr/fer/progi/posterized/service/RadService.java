...
public interface RadService {
    ...
    void updateRad(String admin, String stariNazivRad, String nazivRad, String ime, String prezime, String email, MultipartFile poster, MultipartFile pptx, String nazivKonf);
}
