...
%					\end{packed_item}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Administrator unosi podatke o autoru i radu.
							\item Podaci se dodaju u bazu podataka.
					...
					\noindent \underbar{\textbf{UC6 - Prijava u sustav}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{U7 - Pregled radova sudionika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC8 -  Glasovanje za rad}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC9 - Pregled fotografija u galeriji}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik: }Registrirani korisnik
					...
					\noindent \underbar{\textbf{UC10 - Spremanje fotografija na svoj uređaj}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik: }Registrirani korisnik
					...
					\noindent \underbar{\textbf{UC11 - Direktno video praćenje konferencije}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik: }Registrirani korisnik
					...
					\noindent \underbar{\textbf{UC12 - Završetak konferencije}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC13 - Slanje obavijest o uspjehu i dodjeli nagrada}}
					\begin{packed_item}
