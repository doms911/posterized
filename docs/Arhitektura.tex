...
trenutnih događanja u glavnoj konferencijskoj dvorani\\ \hline 
			...
			\noindent Entitet \textbf {Admin} sadrži informacije o adminima. Sadrži atribute: ID admina, email i lozinka admina. Entitet Admin u binarnoj je vezi s entitetom Konferencija \textit{(One-to-Many)}. 
				\begin{longtblr}[
					label=none,
					entry=none
					]{
